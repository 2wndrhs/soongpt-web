    ...
    <AppScreen>
      <AnimatePresence mode="wait">
        <CourseListContext.Provider value={selectedCourses}>
          <div className="flex max-h-dvh min-h-dvh flex-col gap-8 py-12">
            <AppBar progress={courseSelection[params.type].progress} />
            <motion.div
              key={params.type}
              className="flex flex-1 flex-col items-center gap-8 overflow-auto"
            ...
            >
              <div className="flex w-full flex-1 flex-col items-center overflow-auto">
                ...
                <div className="mt-8 flex w-full flex-1 flex-col gap-3 overflow-auto px-12">
